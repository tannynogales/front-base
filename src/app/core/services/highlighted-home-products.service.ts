...
export class HighlightedHomeProductsService {
  ...
  fetch() {
    ...
    const url =
      this.baseUrl +
      `/products?${environment.productStateFilters}&filters[highlighted][$eq]=true&[categories][site][id][$eq]=${this.siteID}&populate[primary_image]=*&populate[categories]=*&populate[product_attribute_values]=*&pagination[pageSize]=12&sort=highlighted_order`;
